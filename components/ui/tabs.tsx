...
const tabsListVariants = cva(
  "data-[variant=line]:rounded-none group/tabs-list inline-flex w-fit items-center justify-center text-muted-foreground group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col",
  {
    variants: {
      variant: {
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn("hidden text-sm outline-none data-active:block", className)}
      {...props}
    />
  )
}
